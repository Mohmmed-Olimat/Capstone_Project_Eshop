<?php
   ...
   $data=$x->readById($id);
   $customerSet=$data[0];
   $cust_name       =$customerSet['cust_name'];
   $cust_email      =$customerSet['cust_email'];
   $cust_password   =$customerSet['cust_password'];
   $con_pass        ="";
   $cust_mobile     =$customerSet['cust_mobile'];
   $cust_address    =$customerSet['cust_address'];
   $error           =0;
