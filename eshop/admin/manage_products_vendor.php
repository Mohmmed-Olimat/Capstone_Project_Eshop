 <?php
   ...
   if(isset($_POST['submit'])){
    ...
    if($q){
        header("location:manage_products_vendor.php?id=$id");
                                    	 ...
                                    	 if($data=$x->readAll()){
                                    	 	...
                                    	 	foreach ($data as $key => $value) {
                                                ...
                                                echo "<td><img src='assets/img/product/{$value['pro_image']}' width='200' height='100'></td>";
                                    	 		...
                                    	 		echo "<td class='center'><a href='edit_product_vendor.php?id={$value['pro_id']}&catid={$value['cat_id']}&vid={$value['vendor_id']}' class='btn btn-warning'>Edit</a></td>";
                                    	 		echo "<td class='center'><a href='delete_product_vendor.php?id={$value['pro_id']}&vid={$value['vendor_id']}' class='btn btn-danger'>Delete</a></td>";
                                    	 		echo "</tr>";
                                            }
